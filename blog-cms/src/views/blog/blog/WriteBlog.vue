<template>
    <div>
        ...
        <el-form :model="form" :rules="formRules" ref="formRef" label-position="top">
            ...
            <el-alert title="注意：如果从 Typora 中复制 Markdown，粘贴时要选择粘贴为纯文本，否则代码块可能无法被 prismjs 高亮" type="warning" center
                      show-icon></el-alert>
            ...
            <el-form-item label="浏览次数" prop="views">
                <el-input v-model="form.views" placeholder="请输入文章字数（可选）默认为 0" type="number"
        ...
        methods: {
            ...
            getBlog(id) {
                getBlogById(id).then(res => {
                    var vdata = res.data
                    if (vdata.code == '200') {
                        this.computeCategoryAndTag(vdata.data)
                        this.msgSuccess(vdata.msg);
