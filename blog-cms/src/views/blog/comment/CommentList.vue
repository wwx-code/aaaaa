<template>
    <div>
        ...
        <el-row>
            <el-col :span="6">
                <el-select v-model="blogList.id" placeholder="请选择页面" :filterable="true" :clearable="true"
        ...
        <el-table :data="commentList" row-key="id" :tree-props="{children: 'replyComments'}">
            ...
            <el-table-column label="操作" width="200">
                <template v-slot="scope">
                    ...
                    <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteCommentById(scope.row.id)">
                        删除
                    </el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog title="编辑评论" width="50%" :visible.sync="editDialogVisible" :close-on-click-modal="false"
            ...
            <el-form :model="editForm" :rules="formRules" ref="editFormRef" label-width="80px">
                ...
                <el-form-item label="评论内容" prop="content">
                    <el-input v-model="editForm.content" type="textarea" maxlength="255" :rows="5"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            search() {
                this.queryInfo.blogId = this.blogList.id
