<template>
    <div>
        ...
        <el-table :data="categoryList">
            ...
            <el-table-column label="操作">
                <template v-slot="scope">
                    ...
                    <el-popconfirm title="确定删除吗？" icon="el-icon-delete" iconColor="red" @confirm="deleteCategory(scope.row.id)">
        ...
        <!--添加分类对话框-->
        <el-dialog title="添加分类" :visible.sync="addDialogVisible" width="30%" center>
